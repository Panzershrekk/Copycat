...
Shader "Test"
{
	Properties
	{
		...
		_Crash_lp_Fur_AlbedoTransparency("Crash_lp_Fur_AlbedoTransparency", 2D) = "white" {}
	...
	SubShader
	{
		...
		Pass
		{
			...
			sampler2D _Crash_lp_Fur_AlbedoTransparency;
			CBUFFER_START( UnityPerMaterial )
			float4 _Crash_lp_Fur_AlbedoTransparency_ST;
			CBUFFER_END
			...
			half4 frag ( VertexOutput IN  ) : SV_Target
			{
				...
				float2 uv_Crash_lp_Fur_AlbedoTransparency = IN.ase_texcoord6.xy * _Crash_lp_Fur_AlbedoTransparency_ST.xy + _Crash_lp_Fur_AlbedoTransparency_ST.zw;
